...
let Terms =()=>{
    ...
    p1.textContent =`Please read these terms carefully before using our website. By using this website, you agree to abide by them.
...
let Privacy =()=>{
    h.textContent = "Privacy and Policy";
    p1.textContent =`At SYMO, we prioritize the privacy and security of your data. This policy clarifies how we collect, use, and protect your personal information. We only collect the necessary information required to complete your orders and improve your experience on our website, such as contact details, shipping address, and browsing data.
