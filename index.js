...
formSignUp.submit();
      ...
      passwordConfirm.textContent = "Password doesn't Match  ";
    }
...
//Account Validation
 ...
 let form1Account = document.querySelector('#formAccount1');
 let form2Account = document.querySelector('#formAccount2');
 let saveChangesAccount = document.querySelector('#saveChangesAccount')

function accountValidation(){
  if (form1Account.checkValidity() && form2Account.checkValidity()){
  saveChangesAccount.href = "index.html";
form1Account.submit();
form2Account.submit();
  }
  else {
    form1Account.reportValidity(); 
